...
public class FileUtils {
    ...
    public static String removeHidePrefix(String fileName) {
        return fileName.substring(1, fileName.length());
    }

    public static String addHidePrefix(String fileName) {
        return "." + fileName;
    }
    ...
    public static int getFileType(String pathToFile) {
        Log.d(TAG, "getFileType() -> Path to File: " + pathToFile);
    ...
    public static int getEncryptedFileType(String pathToFile) {
        pathToFile = removeEncryptionPrefix(pathToFile);
